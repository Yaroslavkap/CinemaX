...
class Movie(models.Model):
    ...
    poster = models.ImageField("Постер", upload_to="movies/", default='defolt.jpg')
    year = models.PositiveSmallIntegerField("Дата выхода", default=2019)
    country = models.CharField("Страна", max_length=30)
    directors = models.CharField("Режиссер", default='', max_length=100)
    actors = models.CharField("Актеры", default='', max_length=200)
